...
<div class="login">
    <h1>学习的动力就是因为钱</h1>
    <form class="layui-form" action="${base}/login/doLogin" method="post">
...
<script>
    layui.use(['layer', 'form'], function () {
        ...
        $(document).ready(function () {
            var srcBgArray = ["${base}/static/images/login_bg1.jpg",
                "${base}/static/images/login_bg2.jpg",
                "${base}/static/images/login_bg3.jpg",
                "${base}/static/images/login_bg4.jpg",
                "${base}/static/images/login_bg5.jpg",
                "${base}/static/images/login_bg6.jpg"];
