...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        ...
        <#--</div>-->
            ...
            <#--</li>-->
                ...
                <li class="layui-nav-item" mobile>
                    <a href="${base}/logOut" class="signOut"><i class="iconfont icon-loginout"></i> 退出</a>
                </li>
            ...
            <#--</li>-->
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <img src="<#if (user.icon??)>${user.icon}<#else>${base}/static/images/headPhoto.jpg</#if>" class="layui-circle" width="35" height="35">
                        <cite><#if user.alias!''>${user.alias}<#else>${user.username}</#if></cite>
                    </a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${base}/logOut" class="signOut"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="<#if (user.icon??)>${user.icon}<#else>${base}/static/images/headPhoto.jpg</#if>"></a>
            <p>您好！<span class="userName"><#if user.alias!''>${user.alias}<#else>${user.username}</#if></span>, 欢迎登录</p>
        </div>
    ...
    <div class="layui-footer footer">
        <p>Copyright © 为了梦想的BoGe <a href="https://www.baidu.com" target="_blank">粤ICP备181110号 </a></p>
    </div>
</div>
<!-- 移动导航 -->
